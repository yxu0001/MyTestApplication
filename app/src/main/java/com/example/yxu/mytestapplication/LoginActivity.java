...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void pickUserAccount() {
        ...
        Intent intent = AccountPicker.newChooseAccountIntent(null, null, accountTypes, false,
                null, null, null, null);
        startActivityForResult(intent, REQUEST_CODE_PICK_ACCOUNT, null);
    }
    ...
    //String mEmail; // Received fom newChooseAccountIntent(); passed to getToken
    Account mAccount;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_CODE_PICK_ACCOUNT) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                mAccount = new Account(email, type);
     ...
     * If the account is not yet known, invoke the picker. Oce the account is known,
     * start an instance of the AsycTask to get the auth token and do work with it.
     */
    private void getUsername() {
        ...
        if (mAccount == null) {
            ...
            if (isDeviceOnline()) {
                ...
                new GetUsernameTask(LoginActivity.this, mAccount, SCOPE).execute();
            } else {
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.yxu.mytestapplication/http/host/path")
        );
    ...
    public class GetUsernameTask extends AsyncTask<Void, Void, Boolean> {
        ...
        /**
         * Gets authentication token from Google and handles any
        ...
        protected String fetchToken() throws IOException {
            try {
                ...
                // Some other type of unrecoverable exception has occured.
